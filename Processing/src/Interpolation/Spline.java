...
/**
 * Created by sergiodiazpinilla on 27/09/16.
 */
public class Spline {
    ...
    private Spline(List<Float> x, List<Float> y, float[] m) {
        mX = x;
        mY = y;
        mM = m;
    }
     ...
     */
    public static Spline createMonotoneCubicSpline(List<Float> x, List<Float> y) {
